app.controller('GlobalController', ['$scope', '$rootScope', '$location', function ($scope, $rootScope, $location)
{
  ...
  //  alert($rootScope.PaymentBlock);
    ...
    $scope.KnowledgeBasePayment = function () {
        $location.path('/KnowledgeBasePayment');
    }

    $scope.KnowledgeBaseCreateAccount = function () {
        $location.path('/KnowledgeBaseCreateAccount');
    }

    $scope.KnowledgeBaseForgetPassword = function () {
        $location.path('/KnowledgeBaseForgetPassword');
    }
